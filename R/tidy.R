...
#' @param threshold An optional numeric value for filtering the ratio.
#'                        Default is `NULL`, meaning no filtering is applied.
#'                        If provided, only rows with `Ratio` greater than this value are returned.
